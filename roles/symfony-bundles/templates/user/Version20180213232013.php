...
class Version20180213232013 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP SEQUENCE {{ project_database }}.fos_user_id_seq CASCADE');
        $this->addSql('DROP TABLE {{ project_database }}.fos_user');
    }
}
